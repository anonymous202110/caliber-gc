...
public abstract class Storage {
	 ...
	 * 			The predicate that must be true for the value to be returned. 
	 * @param result
	 * 			The value of the record. . All elements of the list can be used from the result value.
	 * 			If the list is empty, key does not exist.  
	 * @return
	 * 			The result of the operation. 
	 */
	public abstract StorageStatus readAll(String key, Predicate<Record> p, List<Record> result);
	 ...
	 * 			The result of the operation. 
	 */
	public abstract StorageStatus delete(String key, Predicate<Record> p);
	 ...
	 * 			The result of the operation. 
	 */
	public abstract StorageStatus getKeys(List<String> result);
	 ...
	 * 			Db as String. 
	 */
	public abstract String getDbAsString();
