...
public class CausalSpartanClient extends DKVFClient {
    ...
    public Map<String, ByteString> rot(Set<String> keys) {
        ...
        String testOutput = "";
        for (Map.Entry<String, ByteString> entry : results.entrySet()) {
            testOutput = testOutput + entry.getKey() + " | " + entry.getValue().toStringUtf8() + " || ";
        }
        protocolLOGGER.severe("ROT result is : " + testOutput);
        return results;
    }
