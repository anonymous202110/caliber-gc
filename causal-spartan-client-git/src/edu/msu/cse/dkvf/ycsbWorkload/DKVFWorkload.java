  ...
  public void doTransactionDelete(DB db) {
		// choose a random key
	  	try {
	  			...
	  			for(int i=0;i<16;i++)
	  				value1[i] = '\0';
	  			ByteIterator value = new ByteArrayByteIterator(value1, 0, 16);
	  			long ist = measurements.getIntendedtartTimeNs();
	  			long st = System.nanoTime();
	  			db.update(keyname, value);
	  			long en = System.nanoTime();
	  			...
	  			measurements.measureIntended("DELETE", (int) ((en - ist) / 1000));
	  	} catch(Exception e) {
	  		measurements.measure("DELETE failed because " + e, 100);
	  	}
